...
class NoteAddScreen extends StatelessWidget {
  ...
  Widget build(BuildContext buildContext) {
    final etTitleController = TextEditingController();
    final etContentController = TextEditingController();
                    ...
                    leading: IconButton(
                      ...
                      onPressed: () => {
                        if (etTitleController.text.isEmpty ||
                          ...
                          context.read<AddRequestCubit>().addNote(
